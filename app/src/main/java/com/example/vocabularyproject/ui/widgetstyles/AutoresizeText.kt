    ...
    Text(
        ...
        onTextLayout = {
           /// Timber.d("onTextLayout")
            Log.i("AutosizeProbs","OnTextLaylot")
            Log.i("AutosizeProbs","${it.hasVisualOverflow},${readyToDraw}")
            if (it.didOverflowHeight && !readyToDraw) {
                Log.i("AutosizeProbs","Did Overflow height, calculate next font size value")
